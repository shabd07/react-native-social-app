...
import { WhichPopUp } from '../actions/profile';
...
const popUp = (ref, whichBtn, whichPopUp) => {
    ...
    switch (whichBtn) {
        ...
        case (3):
            ...
            break;
        case (4):
            ref.popUp.transitionTo({ zIndex: 2, width: 300, left: width / 2 - 150, height: 380, top: height / 2 - 190 });
            break;
        case (5):
...
class CreateProfile extends Component {
    ...
    currentPopUp() {
        ...
        if (this.props.btnNo === 1) {
            ...
            return (
                <View>
                    <View style={{ marginTop: 30, marginBottom: 30 }}>
                        <Text style={{ ...styles.textStyle, fontSize: 18 }}>AGE RANGE</Text>
                    </View>
                    <MultiSlider
                        values={[0, 100]}
                        min={0}
            ...
            return (
                <View>
                    <Button style={styles.buttonStyle} block onPress={() => { genderBtn(this.refs, this.props.WhichPopUp); }} >
            ...
            return (
                <View>
                    ...
                    <Item rounded style={{ width: 270, height: 180 }}>
                        <Input style={{ width: 270, height: 180 }} multiline placeholder="Type here" />
                    </Item>
...
export default connect(mapStateToProps, { WhichPopUp })(CreateProfile);
