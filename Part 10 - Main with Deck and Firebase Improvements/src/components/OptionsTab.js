...
import { ResetProfileState } from '../actions/main';
...
const mapStateToProps = ({ profileState, authState }) => {
    ...
    return { name, user }; // access with this.props.user
};
...
export default connect(mapStateToProps, { ResetProfileState })(OptionsTab);
