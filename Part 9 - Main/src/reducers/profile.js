import { SET_DATA, POP_UP_CHANGED, NAME_CHANGED, GENDER_CHANGED, INFO_CHANGED, AGE_CHANGED, IMAGE_PATH, IMAGE_ERROR, MYAGE_CHANGED } from '../types';
...
export default (state = INITIAL_PROFILE_STATE, action) => {
    ...
    switch (action.type) {
        ...
        case (SET_DATA):
            ...
            return { ...state, age: age, myage: myage, gender: gender, info: info, name: name };
        default:
            return state;
    }
};
