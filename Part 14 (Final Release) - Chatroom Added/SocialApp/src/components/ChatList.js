...
import { UpdateFriendInfo, ChatListLoaded, SetCurrentFriend } from '../actions/main';
                    ...
                    thumbRef.getDownloadURL().then(function (url) {
                        RNFetchBlob
                            ...
                            .then((res) => {
                                ...
                                timer.setTimeout('load_img', storeFriendList, 1000);
                            });
                    })
                }
                            ...
                            renderRow={(item) =>
                                ...
                                >
                                    <TouchableOpacity 
                                        ...
                                        onPress={() => {
                                            this.props.SetCurrentFriend({ _id: item.uid, name: item.name, avatar: item.uri, msguid: item.msg_uid });
                                            Actions.chatRoom();
                                        }}
                                    >
                                        <Left>
...
export default connect(mapStateToProps, { UpdateFriendInfo, ChatListLoaded, SetCurrentFriend })(ChatList);
