...
import { WhichPopUp, OnNameChange, OnInfoChange, OnGenderChange, OnAgeChange, OnImagePressed, OnSubmitPressed } from '../actions/profile';
...
const mapStateToProps = ({ profileState, authState }) => {
    const { btnNo, name, gender, info, age, imageSource, imageError,
    ...
    return {
        user, btnNo, name, gender, info, age, imageSource, imageError, nameValid, ageValid, genderValid, imageValid, infoValid, allValid,
    };
};
                    ...
                    */
                    ...
                    <Animatable.View ref="submit" animation="bounceInLeft" >
                        <Button
                            ...
                            onPress={
                                 () => {
                                    const { user, name, gender, info, age, imageSource, allValid } = this.props;
                                    OnSubmitPressed(user, name, gender, info, age, imageSource, allValid);
                                }
                            }
                        >
